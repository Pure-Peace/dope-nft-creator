...
const DEF_GET_CONTRACT_FOR_ENVIRONMENT = {
  NFTCreator: generateEnvNameContractDefHelper(
    {},
    {lookupName: 'NFTCreator', abiName: 'NFTCreator'}
  ),
  NFTCollection: generateEnvNameContractDefHelper(
    {},
    {lookupName: 'NFTCollection', abiName: 'NFTCollection'}
  ),
  NFTFeeRegistry: generateEnvNameContractDefHelper(
    {},
    {lookupName: 'NFTFeeRegistry', abiName: 'NFTFeeRegistry'}
  ),
  CollectionMaxMinter: generateEnvNameContractDefHelper(
    {},
    {lookupName: 'CollectionMaxMinter', abiName: 'CollectionMaxMinter'}
  ),
  FixedPriceSignatureMinter: generateEnvNameContractDefHelper(
    {},
    {
      lookupName: 'FixedPriceSignatureMinter',
      abiName: 'FixedPriceSignatureMinter',
    }
  ),
  MerkleDropMinter: generateEnvNameContractDefHelper(
    {},
    {lookupName: 'MerkleDropMinter', abiName: 'MerkleDropMinter'}
  ),
  RangeCollectionMinter: generateEnvNameContractDefHelper(
    {},
    {lookupName: 'RangeCollectionMinter', abiName: 'RangeCollectionMinter'}
  ),
  DopeNFT: generateEnvNameContractDefHelper(
    {},
    {lookupName: 'DopeNFTProxy', abiName: 'DopeNFT'}
  ),
};
